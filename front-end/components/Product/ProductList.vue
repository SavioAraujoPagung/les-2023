...
<script setup lang="ts">
    ...
    const modalForm = shallowRef(resolveComponent('product-form'));
    const modalBarcode = shallowRef(resolveComponent('ProductBarCodesForm'));
    ...
    onMounted(() => getAll(ProductType.another));
